<template>
	...
	<div class="bulletin-wrapper">
				...
				<div class="detail"v-if="poiInfo.discounts2"@click="showBulletin"  style="cursor:pointer;color:#FFBB22">
		...
		<div class="discounts"v-if="poiInfo.discounts2">
			...
			<span>{{poiInfo.discounts2[0].info}}</span>
				...
				<div class="close-wrapper">
					<span class="icon-close fa fa-close" @click="closeBulletin" style="cursor:pointer"></span>
				</div>
			</div>
	</div>
	</div>
